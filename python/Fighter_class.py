...
class Fighter: #defines the class
    ...
    def report(self):
        print(self.name+':'+ ' Health: '+ str(self.__health)) #this is what gets printed when we use the report method

    def is_dead(self): #This method determines wether someone is dead or alive
        if self.__health <= 0:
            return True
        else:
            return False

    def random_attack(self): # the mathematical process when someone is attacking someones else
